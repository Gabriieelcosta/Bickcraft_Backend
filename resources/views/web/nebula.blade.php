  ...
  <main class="titulo-bg">
    ...
    <div class="bicicleta container">
      <div class="bicicleta-imagens">
        <img src="{{ url('assets/img/bicicleta/nimbus3.jpg')}}" alt="Bicicleta 1">
        <img src="{{ url('assets/img/bicicleta/nimbus1.jpg')}}" alt="Bicicleta 2">
        <img src="{{ url('assets/img/bicicleta/nimbus2.jpg')}}" alt="Bicicleta 3">
      </div>
  ...
  <article class="seguro-bg">
    <div class="seguro container">
      ...
      <div class="seguro-conteudo">
        ...
        <a class="botao" href="{{route('seguros')}}">Conheça Mais</a>
      </div>
    </div>
  </article>
