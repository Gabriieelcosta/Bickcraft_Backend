...
<body id="contato">
    ...
    <div class="contato container">
      <section class="contato-dados" aria-label="Endereço">
        ...
        <div class="contato-redes">
          <a href="./">
            <img src="{{ url ('assets/img/redes/instagram-p.svg')}}" alt="Instagram">
          </a>
          <a href="./">
            <img src="{{ url ('assets/img/redes/facebook-p.svg')}}" alt="Facebook">
          </a>
          <a href="./">
            <img src="{{ url ('assets/img/redes/youtube-p.svg')}}" alt="Youtube">
          </a>
        </div>
      </section>
  ...
  <article class="lojas container">
    ...
    <div class="lojas-item">
      <img src="{{ url ('assets/img/lojas/rj.jpg')}}" alt="mapa marcando o endereço em Rua Ali Perto, 25 - Rio de Janeiro - RJ">
      <div class="lojas-conteudo">
        ...
        <p class="lojas-tempo font-1-s"><img src="{{ url ('assets/img/icones/horario.svg')}}" alt="">08-18h de seg à dom</p>
      </div>
    </div>

    <div class="lojas-item">
      <img src="{{ url ('assets/img/lojas/sp.jpg')}}" alt="mapa marcando o endereço em Rua Ali Perto, 25 - São Paulo - SP">
      <div class="lojas-conteudo">
